...
open class VoiceAPI {
     ...
     */
    open class func channelsChannelJoinCallPost(channel: ChannelIDModel, apiResponseQueue: DispatchQueue = RevoltAPIClient.apiResponseQueue, completion: @escaping ((_ data: ChannelsVoiceJoinCallResponseModel?, _ error: Error?) -> Void)) {
    ...
    open class func channelsChannelJoinCallPostWithRequestBuilder(channel: ChannelIDModel) -> RequestBuilder<ChannelsVoiceJoinCallResponseModel> {
        ...
        let localVariableRequestBuilder: RequestBuilder<ChannelsVoiceJoinCallResponseModel>.Type = RevoltAPIClient.requestBuilderFactory.getBuilder()
