...
open class ServerMembersAPI {
     ...
     */
    open class func serversServerBansGet(server: ServerIDModel, apiResponseQueue: DispatchQueue = RevoltAPIClient.apiResponseQueue, completion: @escaping ((_ data: ServersServerMembersFetchBansResponseModel?, _ error: Error?) -> Void)) {
     ...
     */
    open class func serversServerBansGetWithRequestBuilder(server: ServerIDModel) -> RequestBuilder<ServersServerMembersFetchBansResponseModel> {
        ...
        let localVariableRequestBuilder: RequestBuilder<ServersServerMembersFetchBansResponseModel>.Type = RevoltAPIClient.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func serversServerMembersGet(server: ServerIDModel, apiResponseQueue: DispatchQueue = RevoltAPIClient.apiResponseQueue, completion: @escaping ((_ data: ServersServerMembersFetchMembersResponseModel?, _ error: Error?) -> Void)) {
     ...
     */
    open class func serversServerMembersGetWithRequestBuilder(server: ServerIDModel) -> RequestBuilder<ServersServerMembersFetchMembersResponseModel> {
        ...
        let localVariableRequestBuilder: RequestBuilder<ServersServerMembersFetchMembersResponseModel>.Type = RevoltAPIClient.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func serversServerMembersMemberDelete(apiResponseQueue: DispatchQueue = RevoltAPIClient.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) {
    ...
    open class func serversServerMembersMemberGetWithRequestBuilder(server: ServerIDModel, member: MemberIDModel) -> RequestBuilder<MemberModel> {
        ...
        let localVariableRequestBuilder: RequestBuilder<MemberModel>.Type = RevoltAPIClient.requestBuilderFactory.getBuilder()
