...
open class ChannelPermissionsAPI {
     ...
     */
    open class func channelsChannelPermissionsDefaultPut(channel: ChannelIDModel, setDefaultPermissionModel: ChannelsChannelPermissionsSetDefaultPermissionModel? = nil, apiResponseQueue: DispatchQueue = OpenAPIClient.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func channelsChannelPermissionsRolePut(channel: ChannelIDModel, role: RoleIDModel, setRolePermissionModel: ChannelsChannelPermissionSetRolePermissionModel? = nil, apiResponseQueue: DispatchQueue = OpenAPIClient.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) {
