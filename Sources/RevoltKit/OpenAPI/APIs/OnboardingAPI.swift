...
open class OnboardingAPI {
     ...
     */
    open class func onboardCompletePost(completeOnboardingModel: ChatPlatformOnboardingCompleteOnboardingModel? = nil, apiResponseQueue: DispatchQueue = OpenAPIClient.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func onboardHelloGet(apiResponseQueue: DispatchQueue = OpenAPIClient.apiResponseQueue, completion: @escaping ((_ data: OnboardingInformationModel?, _ error: Error?) -> Void)) {
    ...
    open class func onboardHelloGetWithRequestBuilder() -> RequestBuilder<OnboardingInformationModel> {
        ...
        let localVariableRequestBuilder: RequestBuilder<OnboardingInformationModel>.Type = OpenAPIClient.requestBuilderFactory.getBuilder()
