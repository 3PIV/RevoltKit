...
open class ChannelInformationAPI {
     ...
     */
    open class func channelsChannelDelete(channel: ChannelIDModel, apiResponseQueue: DispatchQueue = OpenAPIClient.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func channelsChannelGet(channel: ChannelIDModel, apiResponseQueue: DispatchQueue = OpenAPIClient.apiResponseQueue, completion: @escaping ((_ data: ChannelModel?, _ error: Error?) -> Void)) {
    ...
    open class func channelsChannelGetWithRequestBuilder(channel: ChannelIDModel) -> RequestBuilder<ChannelModel> {
        ...
        let localVariableRequestBuilder: RequestBuilder<ChannelModel>.Type = OpenAPIClient.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func channelsChannelPatch(channel: ChannelIDModel, informationEditChannelModel: ChannelsChannelInformationEditChannelModel? = nil, apiResponseQueue: DispatchQueue = OpenAPIClient.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) {
