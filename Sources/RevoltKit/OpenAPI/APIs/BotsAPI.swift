...
open class BotsAPI {
     ...
     */
    open class func botsBotDelete(bot: IdModel, apiResponseQueue: DispatchQueue = OpenAPIClient.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func botsBotGet(bot: IdModel, apiResponseQueue: DispatchQueue = OpenAPIClient.apiResponseQueue, completion: @escaping ((_ data: BotsFetchBotResponseModel?, _ error: Error?) -> Void)) {
    ...
    open class func botsBotGetWithRequestBuilder(bot: IdModel) -> RequestBuilder<BotsFetchBotResponseModel> {
        ...
        let localVariableRequestBuilder: RequestBuilder<BotsFetchBotResponseModel>.Type = OpenAPIClient.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func botsBotInviteGet(bot: IdModel, apiResponseQueue: DispatchQueue = OpenAPIClient.apiResponseQueue, completion: @escaping ((_ data: PublicBotModel?, _ error: Error?) -> Void)) {
    ...
    open class func botsBotInviteGetWithRequestBuilder(bot: IdModel) -> RequestBuilder<PublicBotModel> {
        ...
        let localVariableRequestBuilder: RequestBuilder<PublicBotModel>.Type = OpenAPIClient.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func botsBotInvitePost(bot: IdModel, UNKNOWN_BASE_TYPE: UNKNOWN_BASE_TYPE? = nil, apiResponseQueue: DispatchQueue = OpenAPIClient.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func botsBotPatch(inlineObject29Model: BotsEditBotModel? = nil, apiResponseQueue: DispatchQueue = OpenAPIClient.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func botsCreatePost(inlineObject28Model: BotsCreateBotModel? = nil, apiResponseQueue: DispatchQueue = OpenAPIClient.apiResponseQueue, completion: @escaping ((_ data: BotModel?, _ error: Error?) -> Void)) {
    ...
    open class func botsCreatePostWithRequestBuilder(createBotModel: BotsCreateBotModel? = nil) -> RequestBuilder<BotModel> {
        ...
        let localVariableRequestBuilder: RequestBuilder<BotModel>.Type = OpenAPIClient.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func botsMeGet(apiResponseQueue: DispatchQueue = OpenAPIClient.apiResponseQueue, completion: @escaping ((_ data: BotsFetchOwnedBotsResponseModel?, _ error: Error?) -> Void)) {
    ...
    open class func botsMeGetWithRequestBuilder() -> RequestBuilder<BotsFetchOwnedBotsResponseModel> {
        ...
        let localVariableRequestBuilder: RequestBuilder<BotsFetchOwnedBotsResponseModel>.Type = OpenAPIClient.requestBuilderFactory.getBuilder()
