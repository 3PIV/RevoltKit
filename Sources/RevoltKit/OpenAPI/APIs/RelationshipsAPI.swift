...
open class RelationshipsAPI {
     ...
     */
    open class func usersRelationshipsGet(apiResponseQueue: DispatchQueue = OpenAPIClient.apiResponseQueue, completion: @escaping ((_ data: [UserRelationshipModel]?, _ error: Error?) -> Void)) {
    ...
    open class func usersRelationshipsGetWithRequestBuilder() -> RequestBuilder<[AnyCodableModel]> {
        ...
        let localVariableRequestBuilder: RequestBuilder<[AnyCodableModel]>.Type = OpenAPIClient.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func usersUserBlockDelete(user: UserIDModel, apiResponseQueue: DispatchQueue = OpenAPIClient.apiResponseQueue, completion: @escaping ((_ data: UserRelationshipType?, _ error: Error?) -> Void)) {
    ...
    /**
     ...
     - API Key:
       ...
       - name: Session Token
     - parameter user: (path) User ID 
     - returns: RequestBuilder<RelationshipOnlyModel> 
     */
    open class func usersUserBlockDeleteWithRequestBuilder(user: UserIDModel) -> RequestBuilder<UserRelationshipType> {
        ...
        let localVariableRequestBuilder: RequestBuilder<RelationshipOnlyModel>.Type = OpenAPIClient.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func usersUserBlockPut(user: UserIDModel, apiResponseQueue: DispatchQueue = OpenAPIClient.apiResponseQueue, completion: @escaping ((_ data: UserRelationshipType?, _ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func usersUserRelationshipGet(user: UserIDModel, apiResponseQueue: DispatchQueue = OpenAPIClient.apiResponseQueue, completion: @escaping ((_ data: UserNoIDRelationshipModel?, _ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func usersUsernameFriendDelete(username: UserUsernameModel, apiResponseQueue: DispatchQueue = OpenAPIClient.apiResponseQueue, completion: @escaping ((_ data: UserRelationshipType?, _ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func usersUsernameFriendPut(username: UserUsernameModel, apiResponseQueue: DispatchQueue = OpenAPIClient.apiResponseQueue, completion: @escaping ((_ data: UserRelationshipType?, _ error: Error?) -> Void)) {
